...
<body>
   ...
   <div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <form  action="sessionEtud.php" method="POST" class="box">
                    <h1>Login</h1>
                    <p class="text-muted"> Please enter your information!</p> 
                    <input type="text" name="Username" placeholder="Username" id="Username"> 
                    <input type="text" name="cne" placeholder="CNE" id="CNE">
                     <input type="date" name="datenaissance" placeholder="jj/mm/aa" id="datenaissance"> 
                    <input type="Password" name="apogee" placeholder="code apogée" id="apogée">
